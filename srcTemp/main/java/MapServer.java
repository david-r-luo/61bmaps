...
>>>>>>> c9dfc8c97412f38e30ecd55b89a8bd342c8a764d
    ...
    public static Map<String, Object> getMapRaster(Map<String, Double> params,
        ...
        double initDPP = Math.abs(GraphDB.QUADTREE.root().lrlon - GraphDB.QUADTREE.root().ullon) / 256;
        int depth = 0;
        ...
        findImage(queryRect, GraphDB.QUADTREE, queryDPP, nodeList, depth);
        ...
        for (int i = 0; i < ROUTELIST.size() - 1; i++) {
            int j = i + 1;
            Node nodeI = GraphDB.NODESET.get(ROUTELIST.get(i));
            Node nodeJ = GraphDB.NODESET.get(ROUTELIST.get(j));
    ...
    public static Node findClosestClick(double lon, double lat) {
        Iterator<Node> nodeIterator = GraphDB.NODESET.values().iterator();
    ...
    public static List<Map<String, Object>> getLocations(String locationName) {
        ...
        LinkedList<Node> nodeList = GraphDB.NAMETONODELIST.get(fullName);
